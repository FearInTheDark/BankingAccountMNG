...
public class InApp extends JXFrame {
    ...
    public InApp(Account account) {
        ...
        ImageIcon icon = new ImageIcon("src/main/resources/icons/Login/frame.png");
...
//        splitPane.setUI(new MySplitPaneUI());
    ...
    private void setAccountAvatar() {
        ImageIcon avatar = new ImageIcon("src/main/resources/icons/InApp/Avatar.png");
    }
    ...
    private void createMainPanel() {
        ...
        bgPic = new JLabel();
        ImageIcon bg = new ImageIcon("src/main/resources/icons/InApp/streets.jpg");
        ...
        Arrays.stream(functionsText).forEach(text -> {
            ...
            ImageIcon funcFrame = new ImageIcon("src/main/resources/icons/InApp/functions.png");
            ...
            ImageIcon functionIcon = new ImageIcon("src/main/resources/icons/InApp/FunctionIcons/" + text.toLowerCase() + ".png");
...
//                            splitPane.setRightComponent(cardServices);
    ...
    private void createMenuPanel() {
        ...
        logo = new JLabel();
        ImageIcon logoIcon = new ImageIcon("src/main/resources/icons/InApp/CircleLogo.png");
...
//        others.setPreferredSize(new Dimension(400, 100));
        ...
        ImageIcon settingsIcon = new ImageIcon("src/main/resources/icons/InApp/settings.png");
...
//                splitPane.setRightComponent(fGUI.getMenuGUI(bankNo));
        ...
        ImageIcon logoutIcon = new ImageIcon("src/main/resources/icons/InApp/logout_red.png");
        ...
        logout.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                ...
                ImageIcon logoutIcon = new ImageIcon("src/main/resources/icons/InApp/logout_red_hover.png");
                Icon logoutIconResize = new ImageIcon(logoutIcon.getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT));
                logout.setIcon(logoutIconResize);
            }
    ...
    private Box getBox() {
        ...
        for (int i = 0; i < (isAdmin ? 6 : 5); i++) {
            ImageIcon qAIcon = new ImageIcon("src/main/resources/icons/InApp/" + quickAccessesText[i] + ".png");
...
//                            splitPane.setDividerLocation(300);
    ...
    private Box getSmallBox() {
        ...
        for (int i = 0; i < 5; i++) {
            ImageIcon qAIcon = new ImageIcon("src/main/resources/icons/InApp/" + qAIcons[i]);
