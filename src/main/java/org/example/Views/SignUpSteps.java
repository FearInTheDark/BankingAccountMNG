...
import org.example.Others.Border.RoundedBorder;
...
public class SignUpSteps extends JFrame {
    ...
    private void init() {
        ...
        ImageIcon icon = new ImageIcon("src/main/java/org/example/Views/icons/SignUp/Picture1.png");
        // Resize image
...
//        guideLabel.setBorder(BorderFactory.createLineBorder(Color.BLACK));
        ...
        picLabel.setIcon(new ImageIcon("src/main/java/org/example/Views/icons/SignUp/sign.jpg"));
